export interface Scene {
  id: string;
  filename: string;
  originalNumber: number; // 1 to 30 representing chronological sequence
  title: string;
  description: string;
}
...
export const allScenes: Scene[] = [
  ...
  },
  {
    ...
    description: "Jefferies and Lisa vigilan a Thorwald mientras dos transportistas retiran el gran baúl atado de su apartamento. Jefferies sospecha que allí dentro oculta los restos de su esposa."
  },
  {
    id: "scene-13",
